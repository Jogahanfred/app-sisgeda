...
public interface MiembroService {
	...
	List<MiembroDTO> listarMiembrosACalificarPorPeriodo(Integer idEscuadron, Integer nuPeriodo, String noTipoInstruccion) throws ServiceException;
	Optional<MiembroDTO> buscarPorNsaPorRolPeriodo(String coNsa, Integer nuPeriodo, String noRol) throws ServiceException;
	Optional<MiembroDTO> buscarPorNsa(String coNsa) throws ServiceException;
